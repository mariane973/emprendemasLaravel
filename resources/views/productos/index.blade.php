    ...
    <div class="row text-center mb-5">
      ...
      <div class="collapse d-lg-none col-12" id="menuOpciones">
        <div class="d-flex flex-column align-items-center">
          <div class="Sec_Emp d-flex align-items-center justify-content-center mb-sm-3 mb-2">
            <i class="fas fa-shirt icono me-1" style="color: green; font-size: 18px;"></i>
            <a href="/productos" class="fw-bold" style="color: green;  font-size: 18px;">Productos</a>
          </div>
          <div class="Sec_Zona d-flex align-items-center justify-content-center mb-sm-3 mb-2">
          ...
          <div class="dropdown d-flex align-items-center justify-content-center mb-sm-3 mb-2" id="userDropdown">
          ...
          <div class="Sec_Ofe d-flex align-items-center justify-content-center mb-sm-3 mb-2">
      ...
      <div class="d-none d-lg-flex col-12 justify-content-around">
        <div class="Sec_Emp col-lg-2 d-flex align-items-center justify-content-center">
          <i class="fas fa-shirt icono me-1" style="color: green; font-size: 18px;"></i>
          <a href="/productos" class="fw-bold" style="color: green;  font-size: 18px;">Productos</a>
        </div>
        <div class="Sec_Zona col-lg-2 d-flex align-items-center justify-content-center">
          <i class="fas fa-guitar icono me-1" style="font-size: 20px;"></i>
          <a href="/servicios" class="fw-bold" style="color: #33B66C;  font-size: 18px;">Servicios</a>
        </div>
        <div class="Sec_Emp col-lg-2 d-flex align-items-center justify-content-center">
        ...
        <div class="dropdown col-lg-2 d-flex align-items-center justify-content-center" id="userDropdown">
          <i class="fas fa-tag icono me-1"></i>
          <a href="#" class="fw-bold" style="color: #33B66C;  font-size: 18px;">Ofertas</a>
          <div class="dropdown-content" style="margin-top: 110px">
            <a href="/ofertas" class="fw-bold" style="color: #33B66C;  font-size: 15px;">Ofertas productos</a>
        ...
        <div class="Sec_Ofe col-lg-1 d-flex align-items-center justify-content-center">
          <i class="fas fa-scroll icono me-1"></i>
          <a href="/pedidos_index" class="fw-bold" style="color: #33B66C;  font-size: 18px;">Pedidos</a>
        </div>
        @can('agregarVendedor')
        <div class="Sec_Ofe col-lg-2 d-flex align-items-center justify-content-center">
          <i class="fas fa-clipboard icono me-1"></i>
          <a href="/inventario" class="fw-bold" style="color: #33B66C;  font-size: 18px;">Inventario</a>
        </div>
        @endcan
