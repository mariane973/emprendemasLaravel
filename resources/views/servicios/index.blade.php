...
<section>
  ...
  <div class="row text-center mb-5">
      ...
      <div class="Sec_Ofe col-lg-1 mb-sm-3 col-sm-6 col-md-6 me-4 d-flex align-items-center justify-content-center">
        <i class="fas fa-scroll icono me-1"></i>
        <a href="/pedidos_index" class="fw-bold" style="color: #33B66C;  font-size: 18px;">Pedidos</a>
      </div>
      @can('agregarVendedor')
      <div class="Sec_Ofe col-lg-2 ms-sm-4 mb-sm-3 col-sm-6 col-md-6  d-flex align-items-center justify-content-center">
